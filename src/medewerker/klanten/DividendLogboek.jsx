...
export default function DividendLogboek({ onNieuwStuk, onBewerken, isBeheerder = false }) {
  ...
  async function verwijderRegel(n) {
    ...
    if (typeof window !== "undefined" && !window.confirm(`"${naam}" uit het dividendlogboek verwijderen?\n\nHet stuk in SharePoint en het dividenddossier in Dynamics blijven staan; alleen de vermelding hier verdwijnt.`)) return;
