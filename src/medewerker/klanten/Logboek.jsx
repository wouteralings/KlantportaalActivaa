...
import { History, Link2, Unlink, Pencil } from "lucide-react";
...
const ICOON = { koppel: Link2, ontkoppel: Unlink, bewerken: Pencil };
const KLEUR_ACTIE = { koppel: KLEUR.blauw, ontkoppel: KLEUR.rood, bewerken: KLEUR.subtekst };
