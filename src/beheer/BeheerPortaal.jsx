...
import { Building2, Loader2, LogOut, ShieldAlert, Upload, CheckCircle2, Trash2, Send, Users, LayoutGrid, ExternalLink, Star, Search, Mail, ArrowUp, ArrowDown, HelpCircle, ChevronDown } from "lucide-react";
    ...
    <div style={{ maxWidth: 640, margin: "0 auto", padding: "32px 20px", fontFamily: "system-ui, -apple-system, sans-serif", color: KLEUR.tekst }}>
      ...
      <div style={{ display: "flex", gap: 4, marginBottom: 20, flexWrap: "wrap", borderBottom: `1px solid ${KLEUR.rand}` }}>
        {[
          ...
          const badge = k === "reviews" ? tellingen.nieuweReviews : 0;
          return (
            <button
              key={k}
              onClick={() => setTab(k)}
