...
const { haalStatussen, zetIngeschakeld } = require("../_gedeeld/bezittingenInstellingen");
 ...
 * PUT body { accountId, ingeschakeld } → zet de Bezittingenmodule voor één klant aan/uit.
 */
module.exports = async function (context, req) {
  try {
    ...
    context.res = {
      ...
      body: { error: "Onverwachte fout bij het beheren van de Bezittingenmodule-status.", detail: String(err) },
    };
  }
};
