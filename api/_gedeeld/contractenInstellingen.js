/**
 * Welke klant-accounts (Dataverse accountId) de Contractenmodule (zelf geregistreerde
 * verzekeringen/telefonie/overige doorlopende contracten, met verloopherinneringen) mogen
 * gebruiken.
 *
 * Losse, standalone schakelaar — zelfde opzet als bezittingenInstellingen.js/
 * rapportagesInstellingen.js, NIET afhankelijk van Facturatie of een andere module: Contracten
 * is los per klantaccount aan/uit te zetten.
 *
 * Standaard UIT: een klant ziet de Contracten-tab pas nadat een beheerder deze voor dát
 * specifieke account heeft aangezet in het beheerdersportaal (tab "Facturatie" →
 * "Betaalde functionaliteiten").
 *
 * Opslag in Azure Blob Storage (container portaalcontent, blob contracten-klanten.json):
...
const BLOB_NAAM = "contracten-klanten.json";
...
/** Of de Contractenmodule voor dit ene klant-account is ingeschakeld (standaard false). */
...
/**
 * Legt vast dat een klant heeft gevraagd om de Contractenmodule voor zijn account aan te laten
 * zetten. Zet de module zelf niet aan — dat blijft een bewuste actie van de beheerder in
 * Beheer → Facturatie → Betaalde functionaliteiten.
 */
