 ...
 *
 * Dit bestand heeft een ESM-tweeling in src/medewerker/formulierVoorwaarden.js. Wijzig ze samen.
 */

/** Is de voorwaarde van dit veld vervuld? Zonder voorwaarde: altijd. */
function voldoetAanVoorwaarde(eigen, antwoorden) {
 ...
 */
function zichtbareVeldnamen(velden, instellingen, antwoorden) {
...
function stuurbareVelden(velden) {
 ...
 */
function ibanTekst(waarde, inHokjes) {
...
module.exports = { voldoetAanVoorwaarde, zichtbareVeldnamen, stuurbareVelden, antwoordLabels, lijktOpIban, ibanTekst };
