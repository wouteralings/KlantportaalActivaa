...
const { haalStatussen, zetIngeschakeld } = require("../_gedeeld/urenInstellingen");
 ...
 * PUT body { accountId, ingeschakeld } → zet de urenregistratie voor één klant aan/uit.
 */
module.exports = async function (context, req) {
  try {
    ...
    context.res = {
      ...
      body: { error: "Onverwachte fout bij het beheren van de urenregistratie-status.", detail: String(err) },
    };
  }
};
