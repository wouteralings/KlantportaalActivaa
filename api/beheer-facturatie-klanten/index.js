...
const { haalStatussen, zetIngeschakeld } = require("../_gedeeld/facturatieInstellingen");
 ...
 * PUT body { accountId, ingeschakeld } → zet de facturatiemodule voor één klant aan/uit.
 */
module.exports = async function (context, req) {
  try {
    ...
    context.res = {
      ...
      body: { error: "Onverwachte fout bij het beheren van de facturatiemodule-status.", detail: String(err) },
    };
  }
};
