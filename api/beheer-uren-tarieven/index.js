  ...
  try {
    ...
    if (methode === "POST" || methode === "PATCH") {
      ...
      const opgeslagen = await uren.zetTarief(String(b.email).toLowerCase(), {
        ...
        declarabel_doel: num(b.declarabel_doel), actief: b.actief == null ? true : !!b.actief,
      }, email);
...
function tariefUit(t) {
  if (!t) return { normaal: null, hoog: null, laag: null, declarabelDoel: null, actief: true, gewijzigdOp: null, gewijzigdDoor: "" };
  return {
