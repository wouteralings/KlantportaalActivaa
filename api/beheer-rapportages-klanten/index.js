...
const { haalStatussen, zetIngeschakeld } = require("../_gedeeld/rapportagesInstellingen");
 ...
 * PUT body { accountId, ingeschakeld } → zet de Rapportagemodule voor één klant aan/uit.
 */
module.exports = async function (context, req) {
  try {
    ...
    context.res = {
      ...
      body: { error: "Onverwachte fout bij het beheren van de Rapportagemodule-status.", detail: String(err) },
    };
  }
};
