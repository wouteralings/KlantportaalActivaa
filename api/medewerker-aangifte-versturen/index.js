...
module.exports = async function (context, req) {
  ...
  try {
    ...
    // Onzichtbare koppeling terug naar dit IB-dossier, verstopt in de omschrijving (geen los
    // Dynamics-veld nodig): zodra de cliënt deze taak ondertekent, leest api/taken-ondertekenen dit
    // patroon terug om de dossierstatus automatisch op "Aangifte verzonden naar Belastingdienst" te
