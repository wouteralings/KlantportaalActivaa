...
const { zetAanvraag } = require("../_gedeeld/bezittingenInstellingen");

/**
 * POST /api/bezittingen-aanvraag  body { accountId }
 *
 * Zelfde opzet als api/rapportages-aanvraag — legt alleen de aanvraag vast, zet niets aan.
 */
