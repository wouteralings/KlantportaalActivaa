/**
 * /api/facturatie-instelling — eigen voorkeur van de klant: toon een snelknop "Factuur maken" op de
 * homepagina. Vereist dat de facturatiemodule voor dit account aan staat (controleerToegang).
 * Opgeslagen in dezelfde blob als de facturatie-aan/uit-status (facturatie-klanten.json, veld toonOpHome).
 *
...
const { zetToonOpHome, haalStatussen } = require("../_gedeeld/facturatieInstellingen");
